...
*</label>
                                            <select name="troom"  class="form-control" required>
                                                ...
                                                <option value="Habitacion Twin">HABITACION TWIN</option>
                                                <option value="Matrimonial">HABITACION DOBLE MATRIMONIAL</option>
												<option value="CasaArbol">CASA DEL ARBOL</option>
								...
								<div class="form-group">
                                            ...
                                            <select name="bed" class="form-control" required>
												<option value selected ></option>
                                                <option value="Matrimonial">Cama de 2 Plaza Matrimonial</option>
                                                <option value="CasaArbol">1 Cama Matrimonial y 1 cama plaza y media</option>
												<!-- <option value="Triple">Triple</option>
                                                <option value="Quad">Cuadruple</option> -->
												<option value="Habitacion Twin">1 doble y 1 twin</option>
                                                                                             
                                            </select>
                                            
                               </div>
							 <input type="submit" name="add" value="Nuevo" class="btn btn-primary"> 
							</form>
							<?php
							 include('db.php');
							 if(isset($_POST['add']))
							 {
										...
										{
										 echo '<script>alert("Nueva habitación agregada") </script>' ;
										}else {
