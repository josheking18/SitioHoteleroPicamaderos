...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<ul class="social-icons3">
					<img src="img/qr.png" alt="" width="80px">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="ComoLlegar.php" class="menu__link">Cómo llegar</a></li>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>Hotel Picamadero</h4>
									<h3>Sabemos lo que amas de la Naturaleza</h3>
										<p>Bienvenido a nuestro hotel Picamadero.
</p>
				...
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">leer más
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Amanecer con la Naturaleza</h4>
				...
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">leer más</a>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Amanece en nuestra casa del arbol</h4>
								<h3>Un momento unico frente a la naturaleza</h3>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <span>SUBIR</span></h4>
										...
										<p>Ofrecer a los huéspedes vistas únicas y encantadoras desde sus habitaciones con sus comodidades excepcionales, hace que Hotel picamadero sea uno de los mejores en su tipo. Pruebe nuestro menú de comida, servicios increíbles y un personal amable mientras esté aquí..</p>
									</div>
								</div>
							</div>
						</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Picamadero</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">BALCON CON VISTA A LA NATURALEZA</h4>
							<span class="cbp-ig-category">Picamadero</span>
						</div>
					</li>
					<li>
					...
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Picamadero
</span>
						</div>
					</li>
				</ul>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Acerca de nuestro Hotel picamadero
</h3> 
						   <p class="about-para-w3ls"> Somos un hotel centrado en el turismo deportivo y las actividades al aire libre.
                           Su diseño, inspirado en el colorido plumaje de las aves, busca conectar a nuestros huéspedes
                           con la biodiversidad que ofrece el bosque precordillerano de la Región del Maule.
</p>
...
.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Habitación decorada y vista a la naturaleza
</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Cerca de Reserva nacional 
</p>
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">RESERVAR AHORA
</h3>
				 ...
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<img src="images/r1.jpg" alt=" " class="img-responsive" />
							<h3>Restaurant y servicio hotelero
</h3>
						</div>
						<p>Contamos con Servicio de Restaurant para desayuno, almuerzos y cena, Los esperamos </p>
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<img src="images/r2.jpg" alt=" " class="img-responsive" />
							<h3>Habitación Matrimonial
</h3>
						</div>
						<p>Cama de 2x2mts
                           Baño privado con ducha
                           Toallas incluídas
                           Secador de pelo (pedir en recepción)</p>
						<div class="price-gd-bottom">
							<div class="price-list">
									<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<img src="images/r3.jpg" alt=" " class="img-responsive" />
							<h3>la Casa del Arbol</h3>
						</div>
						<p>Si buscas algo más original, la casa en el árbol es para ti. A 10 mts en lo alto de un Coigüe, se encuentra nuestro refugio con 2 habitaciones (1 doble y 1 twin), baño con ducha, salón, cocina y una bosca para las noches más frías. Además de una terraza donde admirar la naturaleza.</p>
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
	...
	<div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">EXCURSIONES
</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<img src="images/9.jpg" alt=" " class="img-responsive" />
							<h3>Observación flora y fauna
</h3>
						</div>
						<p>Ornitología Avistamiento y observación de aves con más de 50 especies nativas: entre las especies que se pueden avistar destacan el Hued- hued, Concón, Torcaza, Cachaña, Halcón Peregrino, Cóndor, Carpintero Negro, Tucúquere, Picaflor, Queltehue y Loro Tricahue, entre otros. </p>
						<div class="price-gd-bottom">
							   <div class="price-list">
									<ul>
											<li><i class="fa fa-star" aria-hidden="true"></i></li>
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<p>La Reserva Natural Altos del Lircay ofrece variados senderos y rutas.</p>
						<div class="price-gd-bottom">
							<div class="price-list">
									<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<p>Cabalgatas en vilches y reserva alto de lircay, con guia turistico</p>
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
...
<!-- /contact -->
			<div class="copy">
			<img src="img/logchile.png" alt=" " class="logo-image" />
